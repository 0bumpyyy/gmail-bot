...
async function generateLink(platform, userId, title, userToken) {
    try {
...
async function processAccount(account, template, config, logCallback, userId, userToken) {
